...
export default function ThemeToggle() {
  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      {/* Switch Background */}
      <div className="w-12 h-5 bg-zinc-300 dark:bg-zinc-600 rounded-full peer transition-colors duration-300 peer-focus:ring-2 peer-focus:ring-blue-500 peer-focus:ring-offset-2 dark:peer-focus:ring-offset-zinc-900" />
      
      {/* Circle with Icon */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-8 bg-blue-600 dark:bg-zinc-800 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 ease-in-out peer-checked:left-[calc(100%-2rem)] peer-active:scale-95">
